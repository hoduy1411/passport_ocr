...
from src.yolo.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from src.yolo.utils.torch_utils import torch_distributed_zero_first
...
def letterbox_v2(im, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleup=True, stride=32):
